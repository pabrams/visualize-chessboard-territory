...
describe('Chess App', () => {
  ...
  describe('Last Position Feature', () => {
    ...
    test('updates "Last position" on manual input and apply', () => {
        ...
        const manualFEN = 'r1bqkbnr/pppp1ppp/2n5/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq';

        fireEvent.change(input, { target: { value: manualFEN } });
        fireEvent.click(button);

        expect(localStorageMock.setItem).toHaveBeenCalledWith('FEN', manualFEN);
